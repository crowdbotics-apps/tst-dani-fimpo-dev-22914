...
## Project Structure
    ...
    ├── tst_dani_fimpo_dev_22914  # Django project configurations
...
1. Clone this repo and `cd tst_dani_fimpo_dev_22914`
...
2. Clone this repo and `cd tst_dani_fimpo_dev_22914`
